...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/kafka v0.156.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/batchpersignal v0.156.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/kafka/configkafka v0.156.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/kafka/topic v0.156.0
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/zipkin v0.156.0
